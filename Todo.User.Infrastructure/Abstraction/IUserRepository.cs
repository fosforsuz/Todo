...
public interface IUserRepository : IRepository<Domain.Entity.User>
{
    ...
    Task<Domain.Entity.User?> GetUserForOtpLoginAsync(Guid userId, CancellationToken cancellationToken);
    ...
    Task<Domain.Entity.User?> GetUserByPasswordResetTokenAsync(string passwordResetToken,
        CancellationToken cancellationToken);
}